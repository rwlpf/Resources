...
$ActivityLogsPath = $BasePath + "Activities\"+$Filename+"_Activities.csv"
$CapacitiesPath = $BasePath + "Capacities\" + $Filename+"_Capacities.csv"
$RefreshablesPath = $BasePath + "Refreshables\" + $Filename+"_Refreshables.csv"
$GatewaysPath = $BasePath + "Gateways\" + $Filename+"_DataGateway.csv"
$DatasourcesPath = $BasePath + "Datasources\" + $Filename+"_Datasources.json"
$WorkspacesPath = $BasePath + "Workspaces\" + $Filename+"_Workspaces.json"
...
$GroupsData | ConvertTo-Json -Depth 20 | out-File $WorkspacesPath
